...
#include <tas_controllers/cartesian_impedance_controller.h>
...
#include <tas_controllers/pseudo_inversion.h>

namespace tas_controllers {
...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<tas_controllers::compliance_paramConfig>>(
...
void CartesianImpedanceController::complianceParamCallback(
    tas_controllers::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(tas_controllers::CartesianImpedanceController,
